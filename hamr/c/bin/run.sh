...
case "${SCHEDULER}" in
  legacy)
    ...
    launch "CoincidenceLogic_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic_App${EXT} CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_App${EXT} CoincidenceLogic_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic_App${EXT} OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_App${EXT} CoincidenceLogic_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_App${EXT} CoincidenceLogic_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic_App${EXT} CoincidenceLogic_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_App${EXT} OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_App${EXT} OrLogic_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic_App${EXT} Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_App${EXT} OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_App${EXT} Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_App${EXT} InstrumentationMockThread_instrumentationMock_instrumentationMockThread_App${EXT} EventControlMockThread_eventControlMock_eventControlMockThread_App${EXT} ActuatorsMockThread_actuatorsMock_actuatorsMockThread_App${EXT}";
