...
void rts_ScheduleProviderI_getRoundRobinOrder(STACK_FRAME IS_FDDCB6 result) {
  ...
  if(rts_Schedulers_roundRobinSchedule) {
    ...
    // example schedule
    int i = 0;
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_instrumentationMock_instrumentationMockThread(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_eventControlMock_eventControlMockThread(SF_LAST)->id);
    IS_FDDCB6_up(result, i++, (art_Art_BridgeId) rts_Arch_RTS_Instance_actuatorsMock_actuatorsMockThread(SF_LAST)->id);
