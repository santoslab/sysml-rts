...
void rts_ScheduleProviderI_getStaticSchedule(STACK_FRAME art_scheduling_static_Schedule_DScheduleSpec result){
  ...
  if(rts_Schedulers_defaultStaticSchedule) {
    ...
    int i = 0;
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_temperatureLogic_coincidenceLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_saturationLogic_coincidenceLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_pressureLogic_coincidenceLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_actuateTempPressureActuator_orLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_instrumentationMock_instrumentationMockThread(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_eventControlMock_eventControlMockThread(SF_LAST)->id, length);
    fillInSlot(&slotSequence, i++, rts_Arch_RTS_Instance_actuatorsMock_actuatorsMockThread(SF_LAST)->id, length);
    slotSequence.size = i;
