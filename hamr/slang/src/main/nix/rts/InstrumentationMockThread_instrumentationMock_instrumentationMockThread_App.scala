...
object InstrumentationMockThread_instrumentationMock_instrumentationMockThread_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.entryPoints
  val appPortId: Art.PortId = IPCPorts.InstrumentationMockThread_instrumentationMock_instrumentationMockThread_App
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("InstrumentationMockThread_instrumentationMock_instrumentationMockThread_App starting ...")
