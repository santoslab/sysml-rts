...
object EventControlMockThread_eventControlMock_eventControlMockThread_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.RTS_Instance_eventControlMock_eventControlMockThread.entryPoints
  val appPortId: Art.PortId = IPCPorts.EventControlMockThread_eventControlMock_eventControlMockThread_App
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("EventControlMockThread_eventControlMock_eventControlMockThread_App starting ...")
