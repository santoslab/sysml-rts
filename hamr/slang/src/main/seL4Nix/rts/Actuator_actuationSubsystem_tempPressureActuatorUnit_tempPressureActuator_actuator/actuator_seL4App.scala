...
package rts.Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator
...
import rts._
import rts.Actuation.Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_seL4Nix

object actuator_seL4App extends App {

  val actuatorBridge : rts.Actuation.Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_Bridge = {
    val input = Port[Base_Types.Boolean] (id = portId"0", name = "RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_input", mode = DataIn)
    val manualActuatorInput = Port[Base_Types.Boolean] (id = portId"1", name = "RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_manualActuatorInput", mode = DataIn)
    val output = Port[Base_Types.Boolean] (id = portId"2", name = "RTS_Instance_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_output", mode = DataOut)
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    input_port = Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_seL4Nix.input_Receive()

    manualActuatorInput_port = Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_seL4Nix.manualActuatorInput_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(output_port.nonEmpty) {
      Actuator_actuationSubsystem_tempPressureActuatorUnit_tempPressureActuator_actuator_seL4Nix.output_Send(output_port.get)
      output_port = noData
    }
  }
