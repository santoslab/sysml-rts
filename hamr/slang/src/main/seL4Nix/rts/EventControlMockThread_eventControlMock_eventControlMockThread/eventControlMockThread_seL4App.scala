...
package rts.EventControlMockThread_eventControlMock_eventControlMockThread
...
import rts._
import rts.EventControl.EventControlMockThread_eventControlMock_eventControlMockThread_seL4Nix

object eventControlMockThread_seL4App extends App {

  val eventControlMockThreadBridge : rts.EventControl.EventControlMockThread_eventControlMock_eventControlMockThread_Bridge = {
    val manualActuatorInput1 = Port[Base_Types.Boolean] (id = portId"0", name = "RTS_Instance_eventControlMock_eventControlMockThread_manualActuatorInput1", mode = DataOut)
    val manualActuatorInput2 = Port[Base_Types.Boolean] (id = portId"1", name = "RTS_Instance_eventControlMock_eventControlMockThread_manualActuatorInput2", mode = DataOut)
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(manualActuatorInput1_port.nonEmpty) {
      EventControlMockThread_eventControlMock_eventControlMockThread_seL4Nix.manualActuatorInput1_Send(manualActuatorInput1_port.get)
      manualActuatorInput1_port = noData
    }

    if(manualActuatorInput2_port.nonEmpty) {
      EventControlMockThread_eventControlMock_eventControlMockThread_seL4Nix.manualActuatorInput2_Send(manualActuatorInput2_port.get)
