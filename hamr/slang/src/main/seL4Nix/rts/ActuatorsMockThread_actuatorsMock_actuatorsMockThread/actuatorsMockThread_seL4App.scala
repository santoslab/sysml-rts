...
package rts.ActuatorsMockThread_actuatorsMock_actuatorsMockThread
...
import rts._
import rts.Actuators.ActuatorsMockThread_actuatorsMock_actuatorsMockThread_seL4Nix

object actuatorsMockThread_seL4App extends App {

  val actuatorsMockThreadBridge : rts.Actuators.ActuatorsMockThread_actuatorsMock_actuatorsMockThread_Bridge = {
    val tempPressureActuate = Port[Base_Types.Boolean] (id = portId"0", name = "RTS_Instance_actuatorsMock_actuatorsMockThread_tempPressureActuate", mode = DataIn)
    val saturationActuate = Port[Base_Types.Boolean] (id = portId"1", name = "RTS_Instance_actuatorsMock_actuatorsMockThread_saturationActuate", mode = DataIn)
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    tempPressureActuate_port = ActuatorsMockThread_actuatorsMock_actuatorsMockThread_seL4Nix.tempPressureActuate_Receive()

    saturationActuate_port = ActuatorsMockThread_actuatorsMock_actuatorsMockThread_seL4Nix.saturationActuate_Receive()
  }
