...
package rts.InstrumentationMockThread_instrumentationMock_instrumentationMockThread
...
import rts._
import rts.Instrumentation.InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix

object instrumentationMockThread_seL4App extends App {

  val instrumentationMockThreadBridge : rts.Instrumentation.InstrumentationMockThread_instrumentationMock_instrumentationMockThread_Bridge = {
    val unit1_temperatureLogic_channel1 = Port[Base_Types.Boolean] (id = portId"0", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_temperatureLogic_channel1", mode = DataOut)
    val unit1_temperatureLogic_channel2 = Port[Base_Types.Boolean] (id = portId"1", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_temperatureLogic_channel2", mode = DataOut)
    val unit1_temperatureLogic_channel3 = Port[Base_Types.Boolean] (id = portId"2", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_temperatureLogic_channel3", mode = DataOut)
    val unit1_temperatureLogic_channel4 = Port[Base_Types.Boolean] (id = portId"3", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_temperatureLogic_channel4", mode = DataOut)
    val unit1_pressureLogic_channel1 = Port[Base_Types.Boolean] (id = portId"4", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_pressureLogic_channel1", mode = DataOut)
    val unit1_pressureLogic_channel2 = Port[Base_Types.Boolean] (id = portId"5", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_pressureLogic_channel2", mode = DataOut)
    val unit1_pressureLogic_channel3 = Port[Base_Types.Boolean] (id = portId"6", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_pressureLogic_channel3", mode = DataOut)
    val unit1_pressureLogic_channel4 = Port[Base_Types.Boolean] (id = portId"7", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_pressureLogic_channel4", mode = DataOut)
    val unit1_saturationLogic_channel1 = Port[Base_Types.Boolean] (id = portId"8", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_saturationLogic_channel1", mode = DataOut)
    val unit1_saturationLogic_channel2 = Port[Base_Types.Boolean] (id = portId"9", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_saturationLogic_channel2", mode = DataOut)
    val unit1_saturationLogic_channel3 = Port[Base_Types.Boolean] (id = portId"10", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_saturationLogic_channel3", mode = DataOut)
    val unit1_saturationLogic_channel4 = Port[Base_Types.Boolean] (id = portId"11", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit1_saturationLogic_channel4", mode = DataOut)
    val unit2_temperatureLogic_channel1 = Port[Base_Types.Boolean] (id = portId"12", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_temperatureLogic_channel1", mode = DataOut)
    val unit2_temperatureLogic_channel2 = Port[Base_Types.Boolean] (id = portId"13", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_temperatureLogic_channel2", mode = DataOut)
    val unit2_temperatureLogic_channel3 = Port[Base_Types.Boolean] (id = portId"14", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_temperatureLogic_channel3", mode = DataOut)
    val unit2_temperatureLogic_channel4 = Port[Base_Types.Boolean] (id = portId"15", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_temperatureLogic_channel4", mode = DataOut)
    val unit2_pressureLogic_channel1 = Port[Base_Types.Boolean] (id = portId"16", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_pressureLogic_channel1", mode = DataOut)
    val unit2_pressureLogic_channel2 = Port[Base_Types.Boolean] (id = portId"17", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_pressureLogic_channel2", mode = DataOut)
    val unit2_pressureLogic_channel3 = Port[Base_Types.Boolean] (id = portId"18", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_pressureLogic_channel3", mode = DataOut)
    val unit2_pressureLogic_channel4 = Port[Base_Types.Boolean] (id = portId"19", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_pressureLogic_channel4", mode = DataOut)
    val unit2_saturationLogic_channel1 = Port[Base_Types.Boolean] (id = portId"20", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_saturationLogic_channel1", mode = DataOut)
    val unit2_saturationLogic_channel2 = Port[Base_Types.Boolean] (id = portId"21", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_saturationLogic_channel2", mode = DataOut)
    val unit2_saturationLogic_channel3 = Port[Base_Types.Boolean] (id = portId"22", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_saturationLogic_channel3", mode = DataOut)
    val unit2_saturationLogic_channel4 = Port[Base_Types.Boolean] (id = portId"23", name = "RTS_Instance_instrumentationMock_instrumentationMockThread_unit2_saturationLogic_channel4", mode = DataOut)
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(unit1_temperatureLogic_channel1_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_temperatureLogic_channel1_Send(unit1_temperatureLogic_channel1_port.get)
      unit1_temperatureLogic_channel1_port = noData
    }

    if(unit1_temperatureLogic_channel2_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_temperatureLogic_channel2_Send(unit1_temperatureLogic_channel2_port.get)
      unit1_temperatureLogic_channel2_port = noData
    }

    if(unit1_temperatureLogic_channel3_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_temperatureLogic_channel3_Send(unit1_temperatureLogic_channel3_port.get)
      unit1_temperatureLogic_channel3_port = noData
    }

    if(unit1_temperatureLogic_channel4_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_temperatureLogic_channel4_Send(unit1_temperatureLogic_channel4_port.get)
      unit1_temperatureLogic_channel4_port = noData
    }

    if(unit1_pressureLogic_channel1_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_pressureLogic_channel1_Send(unit1_pressureLogic_channel1_port.get)
      unit1_pressureLogic_channel1_port = noData
    }

    if(unit1_pressureLogic_channel2_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_pressureLogic_channel2_Send(unit1_pressureLogic_channel2_port.get)
      unit1_pressureLogic_channel2_port = noData
    }

    if(unit1_pressureLogic_channel3_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_pressureLogic_channel3_Send(unit1_pressureLogic_channel3_port.get)
      unit1_pressureLogic_channel3_port = noData
    }

    if(unit1_pressureLogic_channel4_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_pressureLogic_channel4_Send(unit1_pressureLogic_channel4_port.get)
      unit1_pressureLogic_channel4_port = noData
    }

    if(unit1_saturationLogic_channel1_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_saturationLogic_channel1_Send(unit1_saturationLogic_channel1_port.get)
      unit1_saturationLogic_channel1_port = noData
    }

    if(unit1_saturationLogic_channel2_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_saturationLogic_channel2_Send(unit1_saturationLogic_channel2_port.get)
      unit1_saturationLogic_channel2_port = noData
    }

    if(unit1_saturationLogic_channel3_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_saturationLogic_channel3_Send(unit1_saturationLogic_channel3_port.get)
      unit1_saturationLogic_channel3_port = noData
    }

    if(unit1_saturationLogic_channel4_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit1_saturationLogic_channel4_Send(unit1_saturationLogic_channel4_port.get)
      unit1_saturationLogic_channel4_port = noData
    }

    if(unit2_temperatureLogic_channel1_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_temperatureLogic_channel1_Send(unit2_temperatureLogic_channel1_port.get)
      unit2_temperatureLogic_channel1_port = noData
    }

    if(unit2_temperatureLogic_channel2_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_temperatureLogic_channel2_Send(unit2_temperatureLogic_channel2_port.get)
      unit2_temperatureLogic_channel2_port = noData
    }

    if(unit2_temperatureLogic_channel3_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_temperatureLogic_channel3_Send(unit2_temperatureLogic_channel3_port.get)
      unit2_temperatureLogic_channel3_port = noData
    }

    if(unit2_temperatureLogic_channel4_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_temperatureLogic_channel4_Send(unit2_temperatureLogic_channel4_port.get)
      unit2_temperatureLogic_channel4_port = noData
    }

    if(unit2_pressureLogic_channel1_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_pressureLogic_channel1_Send(unit2_pressureLogic_channel1_port.get)
      unit2_pressureLogic_channel1_port = noData
    }

    if(unit2_pressureLogic_channel2_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_pressureLogic_channel2_Send(unit2_pressureLogic_channel2_port.get)
      unit2_pressureLogic_channel2_port = noData
    }

    if(unit2_pressureLogic_channel3_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_pressureLogic_channel3_Send(unit2_pressureLogic_channel3_port.get)
      unit2_pressureLogic_channel3_port = noData
    }

    if(unit2_pressureLogic_channel4_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_pressureLogic_channel4_Send(unit2_pressureLogic_channel4_port.get)
      unit2_pressureLogic_channel4_port = noData
    }

    if(unit2_saturationLogic_channel1_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_saturationLogic_channel1_Send(unit2_saturationLogic_channel1_port.get)
      unit2_saturationLogic_channel1_port = noData
    }

    if(unit2_saturationLogic_channel2_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_saturationLogic_channel2_Send(unit2_saturationLogic_channel2_port.get)
      unit2_saturationLogic_channel2_port = noData
    }

    if(unit2_saturationLogic_channel3_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_saturationLogic_channel3_Send(unit2_saturationLogic_channel3_port.get)
      unit2_saturationLogic_channel3_port = noData
    }

    if(unit2_saturationLogic_channel4_port.nonEmpty) {
      InstrumentationMockThread_instrumentationMock_instrumentationMockThread_seL4Nix.unit2_saturationLogic_channel4_Send(unit2_saturationLogic_channel4_port.get)
