...
@sig trait InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PreState_Container extends Container {
}

// container for incoming ports
@datatype class InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PreState_Container_P (
  ) extends InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PreState_Container

// container for incoming ports and state variables
@datatype class InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PreState_Container_PS (
  ) extends InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PreState_Container

@sig trait InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PostState_Container extends Container {
...
@datatype class InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PostState_Container_P (
  ...
  val api_unit2_temperatureLogic_channel4: B) extends InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PostState_Container

// container for outgoing ports and state variables
@datatype class InstrumentationMockThread_instrumentationMock_instrumentationMockThread_PostState_Container_PS (
  val api_unit1_pressureLogic_channel1: B,
  val api_unit1_pressureLogic_channel2: B,
  val api_unit1_pressureLogic_channel3: B,
  val api_unit1_pressureLogic_channel4: B,
