...
@sig trait EventControlMockThread_eventControlMock_eventControlMockThread_PreState_Container extends Container {
}

// container for incoming ports
@datatype class EventControlMockThread_eventControlMock_eventControlMockThread_PreState_Container_P (
...
@datatype class EventControlMockThread_eventControlMock_eventControlMockThread_PreState_Container_PS (
  ) extends EventControlMockThread_eventControlMock_eventControlMockThread_PreState_Container
