...
object Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_GumboX {
  ...
  /** IEP-Post: Initialize Entrypoint Post-Condition via container
    ...
    */
  @strictpure def inititialize_IEP_Post_Container (post: Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_PostState_Container_PS): B =
  ...
  @strictpure def compute_CEP_Post_Container(
      pre: Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_PreState_Container_PS,
      post: Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_PostState_Container_PS): B =
    compute_CEP_Post(
