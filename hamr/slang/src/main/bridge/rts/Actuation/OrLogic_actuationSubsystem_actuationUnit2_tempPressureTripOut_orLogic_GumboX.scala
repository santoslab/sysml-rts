...
object OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_GumboX {
  ...
  @strictpure def compute_CEP_Post_Container(
      pre: OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_PreState_Container_PS,
      post: OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_PostState_Container_PS): B =
    compute_CEP_Post(
