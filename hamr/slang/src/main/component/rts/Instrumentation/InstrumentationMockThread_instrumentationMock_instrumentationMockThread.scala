...
object InstrumentationMockThread_instrumentationMock_instrumentationMockThread {

  //=================================================
  //  I n i t i a l i z e    E n t r y    P o i n t
  //=================================================
  def initialise(api: InstrumentationMockThread_Initialization_Api): Unit = {
  ...
  def timeTriggered(api: InstrumentationMockThread_Operational_Api): Unit = {
  ...
  def putFrame(frame: Base_Types.Integer, api: InstrumentationMockThread_Operational_Api): Unit = {
  ...
  def finalise(api: InstrumentationMockThread_Operational_Api): Unit = { }
}
