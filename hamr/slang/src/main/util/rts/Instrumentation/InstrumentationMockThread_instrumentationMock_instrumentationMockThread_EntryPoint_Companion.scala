...
object InstrumentationMockThread_instrumentationMock_instrumentationMockThread_EntryPoint_Companion {
  ...
  def get_api_unit1_temperatureLogic_channel1: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_temperatureLogic_channel1_Id) match {
  ...
  def get_api_unit1_temperatureLogic_channel2: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_temperatureLogic_channel2_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_temperatureLogic_channel3: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_temperatureLogic_channel3_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_temperatureLogic_channel4: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_temperatureLogic_channel4_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_pressureLogic_channel1: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_pressureLogic_channel1_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_pressureLogic_channel2: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_pressureLogic_channel2_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_pressureLogic_channel3: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_pressureLogic_channel3_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_pressureLogic_channel4: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_pressureLogic_channel4_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_saturationLogic_channel1: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_saturationLogic_channel1_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_saturationLogic_channel2: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_saturationLogic_channel2_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_saturationLogic_channel3: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_saturationLogic_channel3_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit1_saturationLogic_channel4: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit1_saturationLogic_channel4_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_temperatureLogic_channel1: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_temperatureLogic_channel1_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_temperatureLogic_channel2: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_temperatureLogic_channel2_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_temperatureLogic_channel3: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_temperatureLogic_channel3_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_temperatureLogic_channel4: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_temperatureLogic_channel4_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_pressureLogic_channel1: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_pressureLogic_channel1_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_pressureLogic_channel2: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_pressureLogic_channel2_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_pressureLogic_channel3: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_pressureLogic_channel3_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_pressureLogic_channel4: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_pressureLogic_channel4_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_saturationLogic_channel1: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_saturationLogic_channel1_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_saturationLogic_channel2: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_saturationLogic_channel2_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_saturationLogic_channel3: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_saturationLogic_channel3_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def get_api_unit2_saturationLogic_channel4: Base_Types.Boolean = {
    Art.observeOutPortVariable(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.operational_api.unit2_saturationLogic_channel4_Id) match {
      case Some(Base_Types.Boolean_Payload(value)) =>
  ...
  def post_initialise(): Unit = {
    ...
    rts.runtimemonitor.RuntimeMonitor.observeInitialisePostState(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.id, rts.runtimemonitor.ObservationKind.RTS_Instance_instrumentationMock_instrumentationMockThread_postInit, postStateContainer_wL)
  }
  ...
  def pre_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    rts.runtimemonitor.RuntimeMonitor.observeComputePreState(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.id, rts.runtimemonitor.ObservationKind.RTS_Instance_instrumentationMock_instrumentationMockThread_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    rts.runtimemonitor.RuntimeMonitor.observeComputePrePostState(Arch.RTS_Instance_instrumentationMock_instrumentationMockThread.id, rts.runtimemonitor.ObservationKind.RTS_Instance_instrumentationMock_instrumentationMockThread_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}