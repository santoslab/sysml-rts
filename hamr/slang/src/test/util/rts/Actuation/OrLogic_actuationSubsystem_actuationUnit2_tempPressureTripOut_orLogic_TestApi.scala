...
@msig trait OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic)
  }
  ...
  def get_actuate_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic.initialization_api.actuate_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }
