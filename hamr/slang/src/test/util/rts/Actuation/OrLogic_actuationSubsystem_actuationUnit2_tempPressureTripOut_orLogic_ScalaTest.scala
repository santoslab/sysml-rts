...
abstract class OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_TestApi {
