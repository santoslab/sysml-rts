...
@msig trait OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P_Trait extends Profile {
  ...
  def update_api_channel1(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P_Trait
  def update_api_channel2(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P_Trait
}
...
@record class OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P(
  ...
  override def update_api_channel1(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P_Trait = {
    return this(api_channel1 = v)
  }

  override def update_api_channel2(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P_Trait = {
...
@msig trait OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_PS_Trait extends OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_P_Trait {
  ...
  def update_api_channel1(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_PS_Trait
  def update_api_channel2(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_PS_Trait
}
...
@record class OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_PS(
  ...
  override def update_api_channel1(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_PS_Trait = {
    return this(api_channel1 = v)
  }

  override def update_api_channel2(v: RandomLib): OrLogic_actuationSubsystem_saturationActuatorUnit_actuateSaturationActuator_orLogic_Profile_PS_Trait = {
    return this(api_channel2 = v)
  }
}
