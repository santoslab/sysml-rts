...
@msig trait CoincidenceLogic_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic)
  }
  ...
  def get_actuate_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.RTS_Instance_actuationSubsystem_actuationUnit2_saturationLogic_coincidenceLogic.initialization_api.actuate_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }
