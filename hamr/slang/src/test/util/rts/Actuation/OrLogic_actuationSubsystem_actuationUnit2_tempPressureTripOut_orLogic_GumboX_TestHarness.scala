...
@msig trait OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_GumboX_TestHarness extends OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_TestApi {
  def verbose: B

  def testComputeCBJ(json: String): GumboXResult.Type = {
    rts.JSON.toActuationOrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_PreState_Container): GumboXResult.Type = {
  ...
  def testComputeCB(
    ...
    val postResult = rts.Actuation.OrLogic_actuationSubsystem_actuationUnit2_tempPressureTripOut_orLogic_GumboX.compute_CEP_Post(api_channel1, api_channel2, api_actuate)
