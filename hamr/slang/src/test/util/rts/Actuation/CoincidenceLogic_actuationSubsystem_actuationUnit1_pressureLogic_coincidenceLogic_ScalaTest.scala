...
abstract class CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  CoincidenceLogic_actuationSubsystem_actuationUnit1_pressureLogic_coincidenceLogic_TestApi {
