...
@msig trait Actuator_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator)
  }
  ...
  def get_output_payload(): Option[Base_Types.Boolean_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.RTS_Instance_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator.initialization_api.output_Id).asInstanceOf[Option[Base_Types.Boolean_Payload]]
  }
