...
abstract class InstrumentationMockThread_instrumentationMock_instrumentationMockThread_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  InstrumentationMockThread_instrumentationMock_instrumentationMockThread_TestApi {
