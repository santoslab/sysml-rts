...
abstract class EventControlMockThread_eventControlMock_eventControlMockThread_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  EventControlMockThread_eventControlMock_eventControlMockThread_TestApi {
