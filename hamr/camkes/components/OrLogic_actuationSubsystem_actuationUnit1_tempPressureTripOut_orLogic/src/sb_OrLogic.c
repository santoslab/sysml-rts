...
Unit rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_actuate_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_OrLogic.c", "", "rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_actuate_Send", 0);

  sb_actuate_write(d);
}

// is_empty channel1: In DataPort
B rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_channel1_IsEmpty(STACK_FRAME_ONLY) {
  return sb_channel1_is_empty();
}

// receive channel1: In DataPort union_art_DataContent
Unit rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_channel1_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_OrLogic.c", "", "rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_channel1_Receive", 0);
...
B rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_channel2_IsEmpty(STACK_FRAME_ONLY) {
  return sb_channel2_is_empty();
}

// receive channel2: In DataPort union_art_DataContent
Unit rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_channel2_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_OrLogic.c", "", "rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_seL4Nix_channel2_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic\n");

  // initialise data structure for data port actuate
  init_sp_union_art_DataContent(sb_actuate, &sb_actuate_seqNum);

  // initialise slang-embedded components/ports
  rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    rts_Actuation_OrLogic_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
